let classMain = function classMain(graph) {
  ...
  function classElements() {
    let contextVar = { src: projectPath + "images/models/feature/rectangle.png", wd: 100, hg: 100, style: "html=1;whiteSpace=wrap;overflow=visible;fontColor=black;strokeColor=#000000;strokeWidth=5;", type: "contextVar", pname: "Context Variable" };
    let stateVar = { src: projectPath + "images/models/component/file.png", wd: 100, hg: 100, style: "html=1;whiteSpace=wrap;overflow=visible;fontColor=black;strokeColor=#000000;strokeWidth=2;", type: "stateVar", pname: "State Variable" };
    let nfr = { src: projectPath + "images/models/component/file.png", wd: 100, hg: 100, style: "html=1;whiteSpace=wrap;overflow=visible;fontColor=black;strokeColor=#000000;strokeWidth=1;", type: "nfr", pname: "Non Functional Requirement" };
    let elements = [];
    elements.push(contextVar);
    elements.push(stateVar);
    elements.push(nfr);
    return elements;
  }
