        ...
        let funct = function(graph, evt, cell)
		{
            ...
            if(oncreation_allowed){
                ...
                new_cells.forEach(element => {
                   ...
                   if (["horizontalPool", "Lane","Variant","baseCompositionModel"].includes(type)) {
                      graph.insertVertex(element, null, '', 0, 0, 0, 0, '');
                      //element.setConnectable(false);
                      //
                        const class_name_type = 'Lane_name';
                        ...
                        const Lane_name = graph.insertVertex(element,null,node_name,0,0,500,20,'fillColor=#FFFFFF;selectable=0;fontColor=black;');
                        Lane_name.setConnectable(false);
